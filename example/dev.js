...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var Modal = ({
    ...
    const handleClickOutside = (0, import_react.useCallback)((e) => {
      var _a;
      const { target } = e;
      if (ref.current && !((_a = ref.current) == null ? void 0 : _a.contains(target)) && modalOpen) {
        onClose();
      }
    ...
    const renderModal = (0, import_react.useMemo)(() => {
      if (!modalOpen) {
        return null;
      }
      ...
      }, closeButtonElement), children));
    }, [modalOpen, children, withShadow, onclose, containerZIndex]);
    return (0, import_react_dom.createPortal)(renderModal, document.body);
  };
  ...
  var App = () => {
    ...
    const handleChangeModal = (0, import_react2.useCallback)(() => {
      setModalOpen((prevState) => !prevState);
    }, [setModalOpen]);
    return /* @__PURE__ */ import_react2.default.createElement("div", null, /* @__PURE__ */ import_react2.default.createElement("h1", null, "Test react modal"), /* @__PURE__ */ import_react2.default.createElement("button", {
      onClick: handleChangeModal
    }, "Click me !"), /* @__PURE__ */ import_react2.default.createElement(src_default, {
      modalOpen,
      onClose: handleChangeModal,
      containerZIndex: 99999,
      withShadow: true
    }, /* @__PURE__ */ import_react2.default.createElement("h1", null, "This is modal content"), /* @__PURE__ */ import_react2.default.createElement("p", null, "You can put your html here, have fun !")));
  };
